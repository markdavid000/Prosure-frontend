      ...
      <Flex padding={"40px 80px"} flexDir="column">
                 ...
                 > 
                  <Image src={arrowLeft} boxSize="15px" mr="8px" />
                   <Text fontSize="16px" color={'#ced4da'} fontWeight="500">Back</Text>
                   </Flex> 
              ...
              <Flex mt="-20px" flexDir="column" p="70px">
                ...
                >
                 ...
                 <Flex flexDir="column">
                     <Flex>
                      <Text fontSize="16px" color={'#e9ecef'} fontWeight="400">#001</Text>
                      <Spacer />
                      <Flex flexDir="column">
                       <Text fontSize="20px" color={'#e9ecef'} fontWeight="600">Sammiejame.eth</Text>
                       <Flex mt="20px">
          ...
          <Flex justifyContent={"center"} align="center" mt="60px">
            <Button 
              ...
              Stake in DAO
                ...
                <Flex flexDir={"column"}>
                 <Flex flexDir="row" justify="space-between">
                        <Text fontSize="18px" color={'#e9ecef'} fontWeight={500}>Balance</Text>
                        <Spacer mr="20px" />
                        <Flex>
                            <Text color="#868e96" fontSize="16px"
                             fontWeight={300}
                              >
                                8,000 USDC
                              </Text>
                  ...
                  <Flex flexDir="row" justify="space-between" mt="10px">
                        <Text fontSize="18px" color={'#e9ecef'} fontWeight={500}>Percentage of DAO</Text>
                        <Spacer mr="20px" />
                        <Flex>
                            <Text color="#868e96" fontSize="16px"
                             fontWeight={300}
                  ...
                  <Flex flexDir="row" justify="space-between" mt="10px">
                        <Text fontSize="18px" color={'#e9ecef'} fontWeight={500}>Voting Power</Text>
                        <Spacer mr="20px" />
                        <Flex>
                            <Text color="#868e96" fontSize="16px"
                             fontWeight={300}
            ...
            <Button bg="#1d0439"
              ...
              Withdraw from DAO
               ...
               <Box mt="-20px" flexDir="column" p="70px">
                <Text fontSize="20px" color={'#e9ecef'} fontWeight="600" mb="15px">Activities</Text>
                ...
                >
                  <Text fontSize="20px" color="#e9ecef" fontWeight="600">This Week</Text>
                ...
                <Button bg="#ffa8a8"
                 ...
                 >
                  ...
                  <Flex alignItems="center" mt="20px">
                    ...
                    <Text fontWeight={600} color="#e9ecef" fontSize="18px">InstadApp Insurance Claim</Text>
                  </Flex>

                  {/* -------------------- Time --------------- */}
                  <Text fontSize="14px" color={'#868e96'} fontWeight="400" mt="10px">22-02-2023, 08:00am</Text>
                </Flex> 
