                ...
                <Stack p="60px" flexDir="column" mt="-50px">
                  ...
                  >
                    <Flex flexDir="row" justify="space-between" mt="30px">
                      <Text color="#848c94" fontWeight="500" fontSize="14px">
                        ID
                      </Text>
                      <Text color="#848c94" fontWeight="500" fontSize="14px">
                        Member address
                    ...
                    <>
                      {daoMembers?.map((item, index) => (
                        ...
                        >
                          <Text color="#B8D0FF" fontSize="16px">
                            #{leadingZero(index + 1, 4)}
                          </Text>
                          <Text
                            fontWeight="600"
                            color="#adb5bd"
